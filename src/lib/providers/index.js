...
// Video generation is routed per-model: PixVerse models go to the PixVerse
// client (and support image-to-video), everything else goes through the
// WaveSpeedAI aggregator (Veo, Kling, Hailuo, Wan, Luma, Sora, LTX, …).
